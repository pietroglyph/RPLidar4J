...
/**
 * This is a queue that is composed of integers. Elements are added and removed
 * from the tail
 *
 * @author Peter Abeles
 */
public class GrowQueue_I32 {
    ...
    /**
     * Inserts the value at the specified index and shifts all the other values
     * down.
     */
    ...
    /**
     * Removes the first 'total' elements from the queue. Element 'total' will be
     * the new start of the queue
     *
    ...
    /**
     * Returns the index of the first element with the specified 'value'. return -1
     * if it wasn't found
     * 
